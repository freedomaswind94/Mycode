...
class NestedUNet_CD(nn.Module):
    def __init__(self,input_nbr=6,label_nbr=2):
        ...
        self.conv0_0 = conv_block_nested(input_nbr, filters[0], filters[0])
        ...
        self.final1 = nn.Conv2d(filters[0], label_nbr, kernel_size = 1)
        self.sigmoid = nn.Sigmoid()
        self.final2 = nn.Conv2d(label_nbr * 4, label_nbr, kernel_size = 1)
...
if __name__ == '__main__':
    ...
    model = NestedUNet_CD(input_nbr = 6,label_nbr =2)
